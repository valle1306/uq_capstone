"""
Train MC Dropout U-Net for uncertainty estimation
Uses dropout during training AND inference for epistemic uncertainty
"""
import os
import sys
import torch
...
def train_mc_dropout(
    ...
    """Train U-Net with MC Dropout"""
    
    print("=" * 60)
    print("MC DROPOUT U-NET TRAINING")
    print("=" * 60)
    ...
    print(f"\n🏗️ Creating U-Net with MC Dropout (dropout={dropout_rate})...")
    model = UNet(in_channels=in_channels, num_classes=1, dropout_rate=dropout_rate)
    model.to(device)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train MC Dropout U-Net")
    ...
    parser.add_argument('--dropout', type=float, default=0.2,
                       help='Dropout rate (critical for MC Dropout!)')
