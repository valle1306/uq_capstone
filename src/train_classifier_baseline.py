"""
Train Baseline Classifier for Medical Image Classification

Standard ResNet-18 classifier without uncertainty quantification.
...
def main():
    ...
    # Output arguments
    parser.add_argument('--output_dir', type=str, default='runs/classification/baseline',
    ...
    print(f"Model created: {args.arch}")
