...
def main():
    ...
    # Training arguments (matching original SWAG paper)
    ...
    # Output arguments
    parser.add_argument('--output_dir', type=str, default='results/mc_dropout_sgd_300',
    ...
    # Loss and optimizer (SGD to match SWAG for apples-to-apples comparison)
