"""
SWAG Training for Chest X-Ray Classification - 300 Epochs
Matches the original SWAG paper training duration (Maddox et al. 2019)

Key details:
- Dataset: Chest X-ray (4172 samples)
- Architecture: ResNet-50 pretrained on ImageNet
- Training: 300 epochs (matching original CIFAR-10 experiments)
- Collection: Epochs 162-300 (last 46% of training, matching original paper)
...
4. Sample with scale=0.0 (mean weights) and scale=0.5 for evaluation
...
def main():
    ...
    # Training (matching original SWAG paper)
    ...
    parser.add_argument('--swa_start', type=int, default=162,
                        help='epoch to start SWAG collection (default: 162, last 46%% of 300 epochs)')
    ...
    # Misc
    parser.add_argument('--output_dir', type=str, default='results/swag_sgd_300',
                        help='output directory (default: results/swag_sgd_300)')
